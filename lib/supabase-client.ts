...
// Use supplied env vars or harmless placeholders so the preview doesn’t crash.
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL ?? "https://placeholder.supabase.co"
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? "public-anon-key"

if (supabaseUrl === "https://placeholder.supabase.co" || supabaseAnonKey === "public-anon-key") {
  // eslint-disable-next-line no-console
  console.warn(
    "Supabase env vars are missing - using placeholder values. " +
